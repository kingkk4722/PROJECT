...
from .views import register , login_view, account_home,logout_view,add_smartphone,add_smartphone_page,transfer_ownership,home,verify_otp
from . import views
...
urlpatterns = [
    ...
    path('verify_otp/<int:ownership_id>/', views.verify_otp, name='verify_otp'),
]
